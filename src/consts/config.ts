...
interface LottieLayer extends BaseLayer {
  __typename: "LOTTIE";
  once: boolean;
  hideOnCompleted: boolean;
}

interface StaticLayer extends BaseLayer {
  __typename: "STATIC";
  asset: {
    src: string;
    width: number;
...
type ConfigItem = LottieLayer | StaticLayer;
...
export { Config, ConfigItem, LottieLayer, StaticLayer, config, phoneConfig };
